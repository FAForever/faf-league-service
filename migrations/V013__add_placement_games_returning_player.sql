...
ADD COLUMN `placement_games_returning_player` INTEGER NOT NULL DEFAULT 3 AFTER placement_games;
UPDATE league_season SET placement_games_returning_player = 3;
